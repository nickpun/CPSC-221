...
public:
	...
	* @param lr is (x,y) of the lower right corner of the rectangle */
    ...
    // given the address to two vectors, a and b, vector add b to a
    void vecAdd(vector<int> & a, vector<int> & b);

    // given the address to two vectors, a and b, vector subtract b from a
    void vecSub(vector<int> & a, vector<int> & b);
};
